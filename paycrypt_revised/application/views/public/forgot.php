		...
		<div class="wrap">
			<div class="content-main">
				<div class="w3ls-subscribe w3ls-subscribe1">
					...
					<p>Please provide the registered email address. We will send you a link that will allow you to reset your password.</p>
					<?php
					...
					<form action="<?php echo base_url() ?>userManager/forget_pass" method="post" id="forgetPass">
						...
						<a href="<?php echo base_url(); ?>login" align="right" style="line-height: 0px;color: #fff; margin-left:20px"">Sign In</a>
					</form>
				</div>
			</div>
