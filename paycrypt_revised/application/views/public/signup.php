			...
			<div class="content-main content-main1">
				<div class="w3ls-subscribe">
					...
					<form action="<?php echo base_url(); ?>userManager/register" method="post" id="register">
						<label  class="error" for="fname"><?php echo form_error('fname'); ?></label><br>
						<input type="text" name="fname" id="fname" placeholder="First Name" value="<?php echo set_value('fname'); ?>" minlength="2" maxlength="16">
						<label  class="error" for="lname"><?php echo form_error('lname'); ?></label>
						<input type="text" name="lname" id="lname" placeholder="Last Name" value="<?php echo set_value('lname'); ?>" minlength="2" maxlength="16">
						<label class="error" for="uemail"><?php echo form_error('uemail'); ?></label>
						<input type="email" name="uemail" id="uemail" placeholder="Email" value="<?php echo set_value('uemail'); ?>" minlength="3" maxlength="30">
