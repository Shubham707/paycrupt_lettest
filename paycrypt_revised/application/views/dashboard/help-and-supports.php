                            ...
                            <div class="card-content">
                              ...
                              <h2 style="text-align:center"><small> Advice And Answers From The <i>Paycrypt</i> Team</small></h2>
                               ...
                               <div class="row" style="margin-top:50px;">
                                 <div class="col-md-4">
                                   <div class="blocks-item">
                                    <a href="<?php echo base_url('orgnisation/paycrypt_services_bitcoin');?>">
                                 ...
                                 <div class="col-md-4">
                                   <div class="blocks-item">
                                    <a href="<?php echo base_url('orgnisation/paycrypt_card');?>">
                                    <div class="blocks-item-link">
                                       <div class="block-icon">
                                 ...
                                 <div class="col-md-4">
                                   <div class="blocks-item">
                                    <a href="<?php echo base_url('orgnisation/paying_with_bitcoin');?>">
                                    <div class="blocks-item-link">
                                       <div class="block-icon">
                               ...
                               <div class="row" style="margin-top:50px;">
                                 ...
                                 <div class="col-md-4">
                                   <div class="blocks-item">
                                   <a href="<?php echo base_url('orgnisation/paycrypt_wallet');?>">
                                   <div class="blocks-item-link">
                                       <div class="block-icon">
                                 ...
                                 <div class="col-md-4">
                                   <div class="blocks-item">
                                    <a href="<?php echo base_url('orgnisation/businesses_organizations');?>">
                                     <div class="blocks-item-link">
                                       <div class="block-icon">
