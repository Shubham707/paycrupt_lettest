              ...
              <div class="col-md-12">
                ...
                <div class="card">
                  <div class="card-header hd-box" data-background-color="blue">
                    <h4 class="title">Your Account » Unrecognised Received Payments </h4>
                  </div>
                                ...
                                <div class="row">
                                  <div class="col-sm-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="amount" class="form-control" placeholder="Amount"><span style="margin: 0px 5px; line-height: 40px;">TO</span>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="amountUSD" class="form-control" placeholder="Approximate Amount in USD"><span style="margin: 0px 5px; line-height: 40px;">TO</span>
                                ...
                                <div class="row">
                                  <div class="col-sm-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="txDate" class="form-control" placeholder="Transaction Time"><span style="margin: 0px 5px; line-height: 40px;">TO</span>
