              ...
              <div class="col-md-12">
                ...
                <div class="card">
                  <div class="card-header hd-box" data-background-color="blue">
                    <h4 class="title"><?php echo $this->session->userdata('userFirstName'); ?> / Your Persional Detail</h4>
                  </div>
 ...
 -->
                ...
                <input type="hidden" name="email" value="<?php echo $this->session->userdata('email');?>">
                                <div class="row">
                                    ...
                                    <button class="btn btn-primary" style="padding: 8px 20%; border-radius: 25px; margin: 0px auto; margin-top: 35px; cursor: pointer;" width="100" name="submit">Create Button<i class="fa fa-paper-plane-o"></i></button>
