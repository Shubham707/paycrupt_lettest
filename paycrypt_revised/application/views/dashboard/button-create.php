                          ...
                          <div class="qr-cd">
                               ...
                               <!--  <form action="<?php echo base_url();?>wallet/payment-wallet" method="post"> -->
                                  ...
                                  <span class="input input--hoshi">
                                    <input class="input__field input__field--hoshi" type="text" name="publicURL" value="<?php echo $privateURL;?>"/>
                                    <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
                                      <span class="input__label-content input__label-content--hoshi">Public Key</span>
                                    </label>
                                  </span>
                                    <input type="hidden" name="collbackurl" value="value="http://www.google.com" >
                                  
                                  <span class="input input--hoshi">                                  
                                    <input class="input__field input__field--hoshi" type="text" name="coinRate" value="<?php echo $coinRate;?>" />
                                    <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">                                    
                                  ...
                                  <div class="form-group">
                                    <label for="comment">Button Copy -:</label>
                                    <textarea class="form-control" rows="8" id="comment">
                                      ...
                                      <body>
                                         <form action="<?php echo base_url();?>paymentcoin" method="post">
                                            ...
                                            <input type="text" name="publicKey" value="<?php echo $value->publicKey;?>" >
                                            <input type="text" name="coinName" value="<?php echo $value->coinName;?>" >
