...
{   
    ...
    public function index()
    {
       ...
       // $data['coins']=$this->Coin_model->listing();
        $this->load->view('dashboard/add_affiliated',$data);
    }
    public function saveAffiliated()
    {
       ...
       // print_r($data); die();
        ...
        redirect(base_url().'account/my_account','refresh');
    }
    public function edit_data()
    {
        $email=$this->session->userdata('userEmail');
        $data['details']=$this->Account_model->affiliatedListEdit($email);
       $this->load->view('dashboard/affiliated',$data);
    }
